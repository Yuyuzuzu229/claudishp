...
// Calcul du total du panier (prix * quantité pour chaque article)
$total = array_sum(array_map(fn($i)=>$i['prix']*$i['qte'], $panier));
?>

<!-- Grille à deux colonnes : articles + récapitulatif -->
<div style="display:grid;grid-template-columns:1fr 320px;gap:24px;align-items:start;">
  ...
  <div class="card card-lg">
    ...
    <!-- Boucle d'affichage de chaque article du panier -->
    ...
    <div style="display:grid;grid-template-columns:80px 1fr auto auto 60px;gap:16px;align-items:center;padding:18px 0;border-bottom:1px solid #F5F5F5;">
      ...
      <!-- Informations produit : nom, taille, couleur -->
      <div>
      ...
      <!-- Contrôle de quantité (boutons + et -) -->
      <div>
      ...
      <!-- Total par ligne et bouton de suppression -->
    ...
    <!-- Liens "Continuer mes achats" et "Vider le panier" -->
  ...
  <div class="order-summary">
    ...
    <!-- Message de sécurité du paiement -->
...
<!-- FEATURES : Barre d'information sur les services -->
...
<script>
// Fonction pour modifier la quantité d'un article (+1 ou -1)
