...
<div class="dash-topbar">
    ...
    <div id="avatar-dropdown-trigger" style="cursor:pointer;position:relative;" onclick="event.stopPropagation();var m=document.getElementById('avatar-dropdown-menu');if(m){m.style.display=m.style.display==='block'?'':'block';}">
...
<script>
document.addEventListener('click',function(){var m=document.getElementById('avatar-dropdown-menu');if(m)m.style.display='none';});
</script>
