...
?>
<!-- Bannière principale de la page FAQ -->
...
<div class="container page-content">
    <!-- Section : Question sur les moyens de paiement -->
    <div class="page-section">
        ...
        <!-- Section : Question sur les délais de livraison -->
        <div class="faq-item">
        ...
        <!-- Section : Question sur les retours -->
        <div class="faq-item">
        ...
        <!-- Section : Question sur le suivi de commande -->
        <div class="faq-item">
